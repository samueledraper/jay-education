      ...
      <section id="workshops" className="mt-16 md:mt-32">
        ...
        <div className="mx-auto mt-16 flex flex-col gap-8">
          <div className="md:flex">
            <div className="mb-8 flex flex-col gap-2 md:w-1/2 md:pr-4">
            ...
            <div className="mb-8 flex flex-col gap-2 md:w-1/2 md:pl-4">
              ...
              ></Image>
              <p className="text-lg font-medium">
                Aim to help understand the challenges your child faces and to
                give you strategies and resources on how to support them.
              </p>
            </div>
          </div>
          ...
          <div className="flex w-full flex-col md:flex-row md:flex-wrap">
            {workshops.map((workshop, i) => {
              return (
                <div key={i} className="flex items-start gap-6 p-2 md:w-1/3">
